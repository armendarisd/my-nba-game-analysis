...
# PART I
#print(analyse_nba_game("NBA_game.txt"))

# PART II
print(print_nba_game_stats(analyse_nba_game("NBA_game.txt"))[0])
print("-------------------------------------------------------------------------------------------------------------------------------------")
print(print_nba_game_stats(analyse_nba_game("NBA_game.txt"))[1])
